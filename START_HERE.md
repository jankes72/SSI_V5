...
```text
PUBLIC = evidence, protocols, results, lineage, counts, QA, hashes, claim boundaries
PRIVATE = source code, private filesystem tree, raw memory, private skill inventory, runtime/configuration, implementation-level architecture
```
